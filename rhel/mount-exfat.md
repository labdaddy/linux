...
- `sudo rpm -v --import http://li.nux.ro/download/nux/RPM-GPG-KEY-nux.ro` and then type: `sudo rpm -Uvh http://li.nux.ro/download/nux/dextop/el7/x86_64/nux-dextop-release-0-5.el7.nux.noarch.rpm`
